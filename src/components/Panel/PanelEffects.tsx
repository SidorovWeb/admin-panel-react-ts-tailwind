            ...
            {isFontSize ? (
                ...
                >
                    <div className="flex items-center">
                        ...
                        <Button
                            clName={`btn-danger ${cl}  ml-[6px]`}
                            onClick={closesPicker}
                        >
                ...
                >
                    <div className="flex items-start">
                        <ChromePicker
                            color={hexColor}
                            onChange={onChange}
                            className="mx-[6px] mt-[2px]"
                        />
                        <Button
                            clName={`btn-danger ${cl}`}
                            onClick={closesPicker}
                        >
                            <MdClose className="h-full w-full" />
                        </Button>
                    ...
                    <div className="flex item-center">
                        <div className="bg-white flex items-center px-4 ml-[4px] rounded">
                            <input
                                ...
                                value={rounded}
                                onChange={(e) =>
                                    onChangeRounded(e.target.value)
                                }
                            ></input>
                        </div>
                        <Button
                            clName={`btn-danger ${cl} mt-0 ml-[6px]`}
                            onClick={closesPicker}
                        >
                            <MdClose className="h-full w-full" />
                        </Button>
