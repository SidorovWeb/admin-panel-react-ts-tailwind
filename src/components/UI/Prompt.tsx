...
export const Prompt: FC = () => {
    ...
    return !isSuccess ? (
        <div className="fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] z-999 p-6 bg-amber-100 dark:text-gray-900 font-medium rounded-lg space-y-4 hover:shadow-lg transition-shadow duration-300 ease-in-out">
            <div className="flex items-center">
                <p>
                    Для редактирования текста наведите и нажмите правую кнопку
                    мыши
                </p>
                <svg
                    fill="currentColor"
